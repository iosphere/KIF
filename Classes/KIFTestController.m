...
- (void)_advanceWithResult:(KIFTestStepResult)result error:(NSError *)error;
{
    ...
    switch (result) {
        case KIFTestStepResultFailure: {
            ...
            [self _writeScreenshotForStep:self.currentStep withPrefix:[NSString stringWithFormat:@"%c-%d FAILED_", (char)[self.scenarios indexOfObject:self.currentScenario]+0x41,[self.currentScenario.steps indexOfObjectIdenticalTo:self.currentStep]]];
        ...
        case KIFTestStepResultSuccess: {
            [self _writeScreenshotForStep:self.currentStep withPrefix:[NSString stringWithFormat:@"%c-%d ", (char)[self.scenarios indexOfObject:self.currentScenario]+0x41,[self.currentScenario.steps indexOfObjectIdenticalTo:self.currentStep]]];
